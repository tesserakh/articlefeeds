...
class SoftwareEngDaily:
    def __init__(self, topic=None):
        if topic:
            self.url = f"https://softwareengineeringdaily.com/category/{topic}/feed/"
        else:
            self.url = "https://softwareengineeringdaily.com/feed"
        self.source = "Software Engineering Daily"
        self.feed = []
